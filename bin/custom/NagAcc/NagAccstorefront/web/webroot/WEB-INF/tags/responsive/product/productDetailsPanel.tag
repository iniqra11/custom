			...
			<div class="row">
				<div class="col-lg-6">
					<div class="product-details">
                        ...
                        <strong> Designed By : ${designer.name} </strong>
                        </c:if>
                        </div>

                        <div>
                        <c:if test="${not empty fName}">
                        FirstName : <strong>${fName}</strong>
                        </c:if>
                        </div>

                          <div>
                            <c:if test="${not empty preferredDesignerName}">
                                <label> By Your Favourite Designer : <strong>${preferredDesignerName}</strong> </label>
                            </c:if>
                          </div>
