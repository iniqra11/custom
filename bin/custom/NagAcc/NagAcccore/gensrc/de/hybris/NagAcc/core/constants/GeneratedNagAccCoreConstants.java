 ...
 * --- Generated at 25-Aug-2021, 6:18:59 PM                     ---
 * ----------------------------------------------------------------
 *  
...
public class GeneratedNagAccCoreConstants
{
	...
	public static class TC
	{
		...
		public static final String DESIGNER = "Designer".intern();
		public static final String DESIGNERBANNERCOMPONENT = "DesignerBannerComponent".intern();
	...
	public static class Attributes
	{
		...
		{
			public static final String HASSAMEDESIGNER = "hasSameDesigner".intern();
		}
		public static class Customer
		{
			public static final String DESIGNERPREFERENCE = "designerPreference".intern();
		}
